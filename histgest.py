...
import vlc
import time
path = "E:\\Hand Gesture OpenCV"
vdo = (path+r"\test_vdo.mp4", path+r"\Faded.mp3")                              ##add ur vdo list here and access via the index
...
face_cascade=cv2.CascadeClassifier(path + r"\frontalface.xml")

#Load the template image of the palm
palm1_bgr = cv2.imread(path + r"\palm1.jpg")
